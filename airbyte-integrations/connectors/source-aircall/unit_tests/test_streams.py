...
import pytest
from source_aircall.source import AircallStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AircallStream, "path", "v0/example_endpoint")
    mocker.patch.object(AircallStream, "primary_key", "test_primary_key")
    mocker.patch.object(AircallStream, "__abstractmethods__", set())
...
def test_request_params(patch_base_class):
    ...
    expected_params = { "per_page": 50, "page": 1 }
...
def test_next_page_token(patch_base_class):
    stream = AircallStream()
    # TODO: replace this with your input parameters
    inputs = {"response": { "json": lambda: { "meta": { "current_page": 2 } } } }
